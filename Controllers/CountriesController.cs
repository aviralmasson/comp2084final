...
namespace COMP2084FinalF2017.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.Countries.ToList().OrderByDescending(Country);
        }

        private ActionResult View<TKey>(Func<Func<Country, TKey>, IOrderedEnumerable<Country>> orderByDescending)
        {
